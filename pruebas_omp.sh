...
do
	...
	do
		...
		time -o "$file" -a -p ./OMP/blur-effect images/720.jpg $radio $NumThread

		echo "Tiempo para imagen de 1080p con un radio de $radio" >> "$file"
		time -o "$file" -a -p ./OMP/blur-effect images/1080.jpg $radio $NumThread

		echo "Tiempo para imagen de 4k con un radio de $radio" >> "$file"
		time -o "$file" -a -p ./OMP/blur-effect images/4k.jpg $radio $NumThread
	done
done
